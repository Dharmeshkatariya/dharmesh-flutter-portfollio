...
class ColorFile{
  ...
  static Color webThemeColor = const Color(0xFF7209b7);

  static Color webThemeColorOpaque5 = webThemeColor.withOpacity(0.05);
  static Color webThemeColorOpaque10 = webThemeColor.withOpacity(0.10);
  static Color webThemeColorOpaque15 = webThemeColor.withOpacity(0.15);
  static Color webThemeColorOpaque50 = webThemeColor.withOpacity(0.50);
  static Color webThemeColorOpaque30 = webThemeColor.withOpacity(0.30);
  static const Color webThemeGradientDarkColor = Color(0xFF4A154B);
  static const Color webThemeGradientLightColor = Color(0xFF83157B);
  // static Color grayEEColor = const Color(0xFFEEEEEE);
  // Lightened version of webThemeColor for grayEEColor replacement
  static Color grayEEColor = Color.lerp(webThemeColor, Colors.white, 0.85)!;

  static Color webDarkThemeColor = const Color(0xFF191923);
  ...
  static Color priorityNornalColor = const Color(0xFF3B1550);
