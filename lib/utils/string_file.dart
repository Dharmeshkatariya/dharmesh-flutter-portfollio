...
// Closing section
  ...
  static String addGroup = 'Add Group';
  static String addCategory = 'Add Category';
  static String categoryName = 'Category Name';
  static String salesAndMarketingHint = "Eg: Sales & Marketing";
  static String permissions = "Permissions";
  static String generalRoles = "General Roles";
  static String entity = "Entity";
  static String reasonForReject = "Reason for Reject";
  static String noRolesDataFound = "No Roles data found.";
  static String saveAndProceed = "Save & Proceed";
  ...
  static String invalidNPI = "Invalid NPI";
  static String entitiesSuccessfullyUpdated = 'Entities successfully updated.';
  static String choosePaymentOption = "Choose Payment Option";
  static String addNewInsurance = "Add New Insurance";
  static String savedInsurance = "Saved Insurance";
  static String reasonCode = "Reason Code";
  static String referralCode = "Referral Code";
  static String referralPreference = "Referral Preference";
  static String referralPreferences = "Referral Preferences";
  static String addNewPreference = "Add New Preference";
  static String addReferralPreference = "Add Referral Preference";
  static String editReferralPreference = "Edit Referral Preference";
  static String addReferralReason = "Add Referral Reason";
  static String editReferralReason = "Edit Referral Reason";
  static String addNewReason = "Add New Reason";
  static String referralReasons = "Referral Reasons";
  ...
  static String copyVisitType = 'Copy Visit Types';
  ...
  static String addVisitCategories = 'Add Visit Categories';
  static String addVisitType = 'Add Visit Type';
  static String editVisitType = 'Edit Visit Type';
  ...
  static String customRange = 'Custom Range';
  static String colorCodeHint = 'Eg: #666666';
  ...
  static String alreadyProvider = 'Already a Provider?';
  static String outOfNetwork = 'Out of Network';
  static String faceMeet = 'FaceMeet';
  static String userGroups = 'User Groups';
  static String userGroup = 'User Group';
  static String assignGroup = 'Assign Group';
  ...
  static String addNewPolicy = 'Add New Policy';
  static String saveAsDraft = 'Save as Draft';
  static String policyHint = 'Terms & Conditions';
  static String title = 'Title';
  static String publishingDate = 'Publishing Date';
  static String moduleAccess = 'Module Access';
  static String thisRecordActive = 'This Record Active';
  static String joinFMNow = 'Join a FaceMeet now';
  static String faceMeetLink = 'FaceMeet Link';
  static String linkValidFor24Hours = 'Link valid for 24 hours';
  static String shareFMLink = 'Share FaceMeet Link';
  static String generateFMLink = 'Generate FaceMeet Link';
  static String joinFM = 'Join FaceMeet';
  static String copyClipboard = 'Copied to Clipboard';
  ...
  static String editFaceMeet = 'Edit FaceMeet';
  static String viewDetails = 'View Details';
  static String copyLink = 'Copy Link';
  static String shareLink = 'Share Link';
  static String cancelFaceMeet = 'Cancel FaceMeet';
  static String faceMeetInsights = 'FaceMeet Insights';
  static String meetingNotes = 'Meeting Notes';
  static String meetingOverViewAndNotes = 'Meeting Overview & Notes';
  static String attachments = 'Attachments';
  static String callSettings = 'Call Settings';
  ...
  static String cameraOff = 'Camera off';
  static String micOn = 'Mic on';
  static String micOff = 'Mic off';
  static String blurBackground = 'Blur background';
  static String clearBackground = 'Clear background';
  static String screenShare = 'screen share';
  ...
  static String startRecording = 'Start Recording';
  static String screenLayout = 'Screen Layout';
  static String raiseHand = 'Raise Hand';
  static String hostControls = 'Host Controls';
  static String submitted = 'Submitted';
  static String renderingProvider = 'Rendering Provider';
  static String billingProvider = 'Billing Provider';
  static String sameAsRenderingProvider = 'Same as Rendering Provider';
  static String deliveryPreference = 'Delivery Preference';
  static String referringProvider = 'Referring Provider';
  static String referringProviderNPI = 'Referring Provider NPI';
  ...
  static String appealed = 'Appealed';
  static String reSubmitted = 'Resubmitted';
  static String accepted = 'Accepted';
  static String denialInformation = 'Denial Information';
  static String payerRemarksAndExplanation = 'Payer Remarks/Explanation';
  static String dateOfDenial = 'Date of Denial';
  static String adjustmentReasonCodes = 'Adjustment Reason Codes';
  static String paymentData = 'Payment Data';
  static String originalBilledAmount = 'Original Billed Amount';
  static String approvedAmount = 'Approved Amount';
  static String deniedAmount = 'Denied Amount';
  static String adjustedAmount = 'Adjusted Amount';
  static String paymentPostingDate = 'Payment Posting Date';

  static String billingHistory = 'Billing History';
  static String transactionsHistory = 'Transactions History';
  static String paymentGateways = 'Payment Gateways';
  static String manageBills = 'Manage Bills';
  static String pulsePay = 'PulsePay';
  ...
  static String useBalance = 'Use Balance';
  static String savedOptions = 'Saved Options';
  static String splitPayment = 'Split Payment';
  static String otherOptions = 'Other Options';
  static String pay = 'Pay';
  static String payVia = 'Pay Via';
  ...
  static String writeOffs = 'Write Offs';
  static String fees = 'Fees';
  static String patientAmt = 'Patient Amt.';
  static String manageDiscounts = 'Manage Discounts';
  static String validity = 'Validity';
  static String discountAndOffers = 'Discount & Offers';
}
