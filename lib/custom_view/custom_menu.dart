...
class CustomMenu{
  void showCustomMenu(
    ...
    showMenu(
        ...
        constraints: BoxConstraints(minWidth: width, maxWidth: width, maxHeight: height,),
  ...
  static void showCustomPopupMenu({
    ...
    if (topPosition + popupHeight > screenHeight) {
      topPosition = screenHeight - popupHeight - 16; // Adjust to fit within the screen
    }
  ...
  // use this
  static void fromTop(BuildContext context, {required Widget child, bool barrierDismissible = true}) {
    showGeneralDialog(
      context: context,
      barrierDismissible: barrierDismissible,
  ...
  static fromBottom(BuildContext context, {required Widget child, bool barrierDismissible = true}){
  ...
  Future customCenterDialog({Widget? child, Offset? endOffset, double? width}) async {
    return Get.generalDialog(
      barrierLabel: "Label",
      ...
      pageBuilder: (context, anim1, anim2) {
        return Align(
            ...
            child: Material(
              ...
              child: Container(
                width: width ?? (Common.isWebSize() ? 550.w : Get.width),
                constraints: BoxConstraints(maxHeight: Common.isWebSize() ? 550.h : 550.w),
                margin: Common.isWebSize() ? EdgeInsets.zero : EdgeInsets.symmetric(horizontal: 20.w),
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        width: width ?? (Common.isWebSize() ? 550.w : Get.width),
                        constraints: BoxConstraints(maxHeight: Common.isWebSize() ? 500.h : 500.w),
      ...
      transitionBuilder: (context, anim1, anim2, child) {
        return SlideTransition(
          position: Tween<Offset>(
            ...
            end: endOffset ?? Offset(0, Common.isWebSize() ? 0.25 : 0.12),
          ).animate(anim1),
          child: child,
        );
      },
  ...
  static  showCustomRightMenu({
    ...
    // ✅ Right Side Position Logic
    final double rightPosition = offset.dx + popupButton.size.width;
    ...
    showMenu(
      ...
      position: RelativeRect.fromLTRB(
        rightPosition,
        offset.dy + (beginFromTop ? -height : popupButton.size.height),
        0,
        offset.dy + popupButton.size.height,
      ),
