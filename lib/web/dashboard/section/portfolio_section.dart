...
class _PortfolioSectionState extends State<PortfolioSection> {
  ...
  double _getChildAspectRatio(BuildContext context) {
    ...
    // For larger screens, use bigger aspect ratios to make cards wider
    if (width > 2000) return 1.2; // 4K and ultra-wide screens
    if (width > 1600) return 1.1; // Large desktop monitors
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                // Info Icon (replaced expand icon)
                                FlipInX(
                                  duration: 300.ms,
                                  child: IconButton(
                                    icon: Icon(
                                    ...
                                    onPressed: _showProjectDetailsPopup,
                                    splashRadius: 20,
                                  ),
                                ),
                              ],
                            ...
                            // // Short preview description - FIXED: Added constraints
                            // Container(
                            //   constraints: BoxConstraints(
                            //     maxHeight: 50.h, // Reduced height
                            //   ),
                            //   child: Text(
                            //     widget.item.description ?? '',
                            //     style: TextStyle(
                            ...
                            // Action Buttons - FIXED: Removed from flexible space
                            Row(
                              children: [
                                Expanded(
